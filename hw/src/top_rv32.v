...
`ifdef _STALL_DEBUG_
  assign if_stall_w = if_stall;
  assign id_stall_w = id_stall;
  assign ex_stall_w = ex_stall;
`else 
  assign if_stall_w = 0;
  assign id_stall_w = 0;
  assign ex_stall_w = 0;

  assign if_stall = if_stall_w;
  assign id_stall = id_stall_w;
  assign ex_stall = ex_stall_w;
`endif
  ...
  mem_stage u_mem_stage (
    ...
    .dmem_din_o          (dmem_w_data_o),
    .dmem_dout_i         (dmem_r_data_i),
